...
fleched =[
    [pg.Rect(200, 80, 200, 200), pg.Rect(200, 80, 160, 80)],
    [pg.Rect(300, 80, 200, 200), pg.Rect(300, 80, 160, 80)],
    [pg.Rect(400, 80, 200, 200), pg.Rect(400, 80, 160, 80)],
    [pg.Rect(500, 80, 200, 200), pg.Rect(500, 80, 160, 80)],



]
flecheg =[
    [pg.Rect(550, 550, 200, 200), pg.Rect(550, 550, 160, 80)],
    [pg.Rect(450, 550, 200, 200), pg.Rect(450, 550, 160, 80)],
    [pg.Rect(340, 550, 200, 200), pg.Rect(340, 550, 160, 80)],
    [pg.Rect(230, 550, 200, 200), pg.Rect(230, 550, 160, 80)],


]
flecheb =[
    [pg.Rect(600, 80, 200, 200), pg.Rect(600, 70, 80, 150)],
    [pg.Rect(600, 180, 200, 200), pg.Rect(600, 170, 80, 150)],
    [pg.Rect(600, 280, 200, 200), pg.Rect(600, 270, 80, 150)],
    [pg.Rect(600, 380, 200, 200), pg.Rect(600, 370, 80, 150)],
    [pg.Rect(600, 480, 200, 200), pg.Rect(600, 470, 80, 150)]
]
flecheh =[


    [pg.Rect(200, 400, 200, 200), pg.Rect(200, 400, 80, 150)],
    [pg.Rect(200, 500, 200, 200), pg.Rect(200, 500, 80, 150)],
    [pg.Rect(200, 300, 200, 200), pg.Rect(200, 300, 80, 150)],
    [pg.Rect(200, 200, 200, 200), pg.Rect(200, 200, 80, 150)],
    [pg.Rect(200, 100, 200, 200), pg.Rect(200, 100, 80, 150)]
]
